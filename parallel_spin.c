...
insertion time on 40 threads  using mutex: 0.0284 s
retrieval time on 40 threads  using mutex: 10.8199 s

There is a significant overhead using spinlocks.

insertion time on 40 threads  using spinlock: 0.2223 s
retrieval time on 40 threads  using spinlock: 41.602 s
*/
